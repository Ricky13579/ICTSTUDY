...
<body>
	...
	<h3>회원가입 페이지</h3>
	<hr>
	<form action="joinDAOImpl.jsp" action="post" name="frm">
		<table border="1" cellspacing="0" cellpadding="10">
			...
			<tr>
				...
				<td>
					<input type="text" id="user_id" name="userID" size="30" required autofocus>
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				<th>
					<label for="user_re_pwd">비밀번호 확인</label>
				</th>
				<td>
					<input type="password" id="user_re_pwd" name="userPwd" size="30" required>
				</td>
			</tr>
			<tr>
				<th>
